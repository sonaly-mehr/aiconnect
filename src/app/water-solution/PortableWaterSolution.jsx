...
const PortableWaterSolution = () => {
  return (
    <div className="lg:w-[90%] mx-auto pb-20 pt-[135px]">
      <h2 className="font-bowler text-[#005CAB] uppercase text-5xl leading-[24px] text-center mb-5">
        POTABLE WATER SOLUTIONS
      </h2>
      <div>
        <Image src="/assets/portable.svg" alt="" width={500} height={200} className="w-full h-auto"/>
      </div>
      <h4 className="text-[#848484] font-geometria font-medium mt-3 mb-2 text-[22px] capitalize">
        Work with the technology/process joint team under one umbrella to
        address all the above issues
      </h4>
      <ul className="text-base text-[#787878] font-geometria font-normal flex flex-col ga-2 pl-4">
